...
process_text <- function(file_path) {
  ...
  text <- tolower(readLines("Biden 2021.txt", encoding = "UTF-8"))
...
file_paths <- c("Biden 2021.txt", "Biden 2024.txt")  # Uzupełnij nazwy plików i ustaw Working Directory!
